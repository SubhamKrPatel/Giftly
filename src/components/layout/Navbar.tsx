      ...
      >
        <div className="bg-white/95 backdrop-blur-md border-t border-warm-200 px-4 py-4 space-y-1">
          ...
          <div className="pt-3 border-t border-warm-200 flex flex-col gap-2">
            <Link
              to="/login"
              className="block text-center px-4 py-3 text-sm font-medium text-neutral-600 hover:text-rose-600 rounded-xl hover:bg-rose-50 transition-colors duration-200"
            >
              Login
            </Link>
            <Link
